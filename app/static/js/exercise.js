...
/******/ 	__webpack_require__.p = "http://localhost:2992/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.typesetMath = exports.startMathJax = undefined;
	...
	var COMBINED_MATH_SELECTOR, MATH_DATA_SELECTOR, MATH_MARKER_BLOCK, MATH_MARKER_INLINE, MATH_ML_SELECTOR, MATH_RENDERED_CLASS, setAsRendered, startMathJax, typesetDocument, typesetMath;
	...
	setAsRendered = function setAsRendered(node, type) {
	  if (type == null) {
	    type = 'mathjax';
	  }
	...
	typesetDocument = function typesetDocument() {
	  ...
	  allNodes = allNodes.concat(_underscore2.default.pluck(document.querySelectorAll(MATH_ML_SELECTOR), 'parentNode'));
	...
	typesetDocument = _underscore2.default.debounce(typesetDocument, 10);

	exports.typesetMath = typesetMath = function typesetMath(root) {
	  var ref, ref1;
	...
	exports.startMathJax = startMathJax = function startMathJax(callback) {
	  ...
	  configuredCallback = function configuredCallback() {
	...
	exports.startMathJax = startMathJax;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mathjax = __webpack_require__(8);
	...
	var App = {
	  start: function start() {
	    (0, _mathjax.startMathJax)();
	  },
	  typeSetMath: function typeSetMath() {
	    (0, _mathjax.typesetMath)(document);
	  }
	};
